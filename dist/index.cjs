...
var require_util = __commonJS({
  "node_modules/ajv/dist/compile/util.js"(exports2) {
    ...
    exports2.escapeJsonPointer = escapeJsonPointer2;
    function unescapeJsonPointer2(str) {
      return str.replace(/~1/g, "/").replace(/~0/g, "~");
    }
    exports2.unescapeJsonPointer = unescapeJsonPointer2;
  ...
  "node_modules/fast-uri/index.js"(exports2, module2) {
    ...
    function normalize(uri, options2) {
      if (typeof uri === "string") {
        uri = /** @type {T} */
        serialize(parse(uri, options2), options2);
...
// node_modules/@seriousme/openapi-schema-validator/index.js
...
// node_modules/@seriousme/openapi-schema-validator/resolve.js
...
var pointerWords = /* @__PURE__ */ new Set(
  /** @type {const} */
  [
    "$ref",
    "$id",
...
function replaceRefs(tree) {
  return resolve(tree, true);
}
function checkRefs(tree) {
  try {
    resolve(tree, false);
    return { valid: true };
  } catch (err) {
...
function resolve(tree, replace) {
  ...
  function applyRef(path, target) {
    ...
    for (const p of paths) {
      root = /** @type {RecordStringUnknown} */
      root[unescapeJsonPointer(p)];
    }
...
// node_modules/@seriousme/openapi-schema-validator/index.js
var import_meta = {};
var { default: addFormats } = import_ajv_formats.default;
var openApiVersions = /* @__PURE__ */ new Set(["2.0", "3.0", "3.1", "3.2"]);
var ajvVersions = {
  // @ts-expect-error using pure typescript doesn't produce an error
  "http://json-schema.org/draft-04/schema#": import_ajv_draft_04.default,
  // @ts-expect-error using pure  typescript doesn't produce an error
  "https://json-schema.org/draft/2020-12/schema": import__.default
};
var inlinedRefs = "x-inlined-refs";
function localFile(fileName) {
  return (0, import_node_url.fileURLToPath)(new import_node_url.URL(fileName, import_meta.url));
}
function importJSON(file) {
  return JSON.parse((0, import_node_fs.readFileSync)(localFile(file), "utf-8"));
}
...
async function loadSpecFromData(data) {
  ...
  if (!sourceData.match(/\n/)) {
    try {
      sourceData = await (0, import_promises.readFile)(data, "utf-8");
      fileName = data;
    } catch (_) {
      return {
        loaded: false,
  ...
  try {
    return {
      ...
      spec: (
        /** @type {SpecFromData} */
        (0, import_js_yaml.load)(sourceData, { schema: import_js_yaml.JSON_SCHEMA })
      )
    };
  } catch (_) {
    return {
